...
import org.boc.ui.ly.LyTip;

public class LyTipMouseMotion extends MouseMotionAdapter{
	private LyTip tip;
	...
	public LyTipMouseMotion(MyTextPane textPane,BasicJPanel bframe) {
		this.frame = (LiuYaoFrame)bframe;
		tip = new LyTip(textPane, frame);
		w = 30;
		h = 135;
