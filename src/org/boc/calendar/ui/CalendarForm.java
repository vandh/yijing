 ...
 * 4)添加小时和分钟
 */
public abstract class CalendarForm extends JFrame implements ActionListener {
	...
	public CalendarForm() {		
		...
		this.main.setFont(CalendarForm.font);
		...
		table.setFont(CalendarForm.font);
    ...
    table.setBorder(LineBorder.createBlackLineBorder());
		...
		timeLabel.setFont(CalendarForm.font);
		...
		main.add(timeLabel);
		time = new TimesLabel();
		time.setFont(CalendarForm.font);
    ...
    html.setFont(CalendarForm.font);
		...
		public void focusLost(FocusEvent e) {
			if(e.getSource().equals(tf)) {
				...
				try{
					...
					tf.setText(iyear+"");
					CalendarForm.this.model.setSelectYear(iyear);
				}catch(Exception exception) {
					tf.setText(CalendarForm.this.model.getSelectYear()+"");
				}
				CalendarForm.this.model.fireTableDataChanged();
				CalendarForm.this.initLunar();
				reDo(1);   //重新起局
				...
				try{
					...
					hf.setText(CalendarForm.this.model.getCurrentHour()+"");
				}
				reDo(4);   //重新起局
				...
				try{
					...
					mf.setText(CalendarForm.this.model.getCurrentMinute()+"");
				}
	...
	class LinkLabel extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent e) {
			CalendarForm.this.model.setSelectYear(CalendarForm.this.model.getCurrentYear());
			CalendarForm.this.model.setSelectMonth(CalendarForm.this.model.getCurrentMonth());
			CalendarForm.this.model.setSelectDay(CalendarForm.this.model.getCurrentDay());
			CalendarForm.this.tf.setText(CalendarForm.this.model.getCurrentYear()+"");
			CalendarForm.this.select.setSelectedIndex(CalendarForm.this.model.getCurrentMonth());
			CalendarForm.this.hf.setText(CalendarForm.this.model.getCurrentHour()+"");
			CalendarForm.this.mf.setText(CalendarForm.this.model.getCurrentMinute()+"");
		...
		public void initText(JLabel o) {
			o.setText("<html><div style='vertical-align:top;' ><font color=blue><U>" + CalendarForm.this.LINKTEXT +"</U></font></div></html>");
		}
		private void setText(MouseEvent e, boolean b) {
			...
			if (!b)
				...
				o.setText("<html><div style='vertical-align:top;' ><font color=blue><U><b>" + CalendarForm.this.LINKTEXT +"</b></U></font></div></html>");
		}
	}
	...
	public void updateDate(int year,int month,int day,int hour,int minute) {
		...
		CalendarForm.this.model.fireTableDataChanged();
		CalendarForm.this.initLunar();  //主要是更新html显示面板
	}
